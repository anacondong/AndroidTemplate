package com.example.ittipol.masterdetail;
...
public class ItemsDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(ItemsDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(ItemsDetailFragment.ARG_ITEM_ID));
